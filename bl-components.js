module.exports = (theme) => ({
    ...
    '.form-section': {
      '@apply shadow bg-white md:rounded-md md:p-6 p-4': {}
    },
    
    '.bl-input': {
      '@apply w-full rounded-md text-base text-bl-grey-900 leading-6 bg-white border border-bl-grey-200 px-3 py-2 shadow-sm': {}
    },
    '@screen sm': {
      '.bl-input': {
        '@apply text-sm': {}
    ...
    '.search-filter-bl-input': {
      '@apply w-full text-base text-bl-grey-900 border border-bl-grey-200 shadow-sm': {}
    },
    ...
    '.form-radio': {
      '@apply border border-bl-grey-300 mr-3': {}
    },
    ...
    '.bl-button-primary-circular': {
      '@apply bg-bl-orange-500 fixed rounded-full shadow-md right-0 mb-5 mr-5 p-6 z-10 text-white': {}
    },
    ...
    '.bl-blue-gradient': {
      background: 'linear-gradient(193.04deg, rgba(255, 255, 255, 0.2) 0%, rgba(255, 255, 255, 0) 55.87%), var(--bl-blue-500)'
    },
